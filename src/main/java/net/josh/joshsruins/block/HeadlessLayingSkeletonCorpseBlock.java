...
public class HeadlessLayingSkeletonCorpseBlock extends HorizontalFacingBlock {
    public static final MapCodec<HeadlessLayingSkeletonCorpseBlock> CODEC = createCodec(HeadlessLayingSkeletonCorpseBlock::new);
    private static final VoxelShape SHAPE = Block.createCuboidShape(0.0, 0.0, 0.0, 16.0, 5.0, 16.0);

    public HeadlessLayingSkeletonCorpseBlock(Settings settings) {
        super(settings);
