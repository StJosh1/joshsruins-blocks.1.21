...
public class BurningSkeletonCorpseBlock extends HorizontalFacingBlock {
    public static final MapCodec<BurningSkeletonCorpseBlock> CODEC = createCodec(BurningSkeletonCorpseBlock::new);
    private static final VoxelShape SHAPE = Block.createCuboidShape(0.0, 0.0, 0.0, 16.0, 10.0, 16.0);

    public BurningSkeletonCorpseBlock(Settings settings) {
        super(settings);
