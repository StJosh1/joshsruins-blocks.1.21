...
public class SkeletonCorpseBlock extends HorizontalFacingBlock {
    public static final MapCodec<SkeletonCorpseBlock> CODEC = createCodec(SkeletonCorpseBlock::new);
    private static final VoxelShape SHAPE = Block.createCuboidShape(0.0, 0.0, 0.0, 16.0, 10.0, 16.0);

    public SkeletonCorpseBlock(Settings settings) {
        super(settings);
