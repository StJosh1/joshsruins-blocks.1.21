...
public class LayingSkeletonCorpseBlock extends HorizontalFacingBlock {
    public static final MapCodec<LayingSkeletonCorpseBlock> CODEC = createCodec(LayingSkeletonCorpseBlock::new);
    private static final VoxelShape SHAPE = Block.createCuboidShape(0.0, 0.0, 0.0, 16.0, 5.0, 16.0);

    public LayingSkeletonCorpseBlock(Settings settings) {
        super(settings);
