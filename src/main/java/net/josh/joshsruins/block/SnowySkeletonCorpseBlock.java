...
public class SnowySkeletonCorpseBlock extends HorizontalFacingBlock {
    public static final MapCodec<SnowySkeletonCorpseBlock> CODEC = createCodec(SnowySkeletonCorpseBlock::new);
    private static final VoxelShape SHAPE = Block.createCuboidShape(0.0, 0.0, 0.0, 16.0, 10.0, 16.0);

    public SnowySkeletonCorpseBlock(Settings settings) {
        super(settings);
