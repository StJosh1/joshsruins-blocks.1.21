...
public class MossyLayingSkeletonCorpseBlock extends HorizontalFacingBlock {
    public static final MapCodec<MossyLayingSkeletonCorpseBlock> CODEC = createCodec(MossyLayingSkeletonCorpseBlock::new);
    private static final VoxelShape SHAPE = Block.createCuboidShape(0.0, 0.0, 0.0, 16.0, 5.0, 16.0);

    public MossyLayingSkeletonCorpseBlock(Settings settings) {
        super(settings);
